...
steel_sword = Weapon(name="Steel Sword", weapon_type="sharp", min_damage=3, max_damage=12, value=80)
battle_axe = Weapon(name="Battle Axe", weapon_type="sharp", min_damage=4, max_damage=14, value=100)
fire_breath = Weapon(name="Fire Breath", weapon_type="elemental", min_damage=5, max_damage=18, value=100)